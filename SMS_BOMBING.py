#DECODE BY RUDRA_Z
#SOB KA BAP RUDRA_Z
#NEXT TIME AR ABALMI KORTE ASIS NA ABAL 🖕
...
╚═╝░░╚═╝░╚═════╝░╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝
        ...
        \033[1;91m\033[1;41m\033[1;97m             RAUDRA_Z        \033[;0m\033[1;91m\033[1;92m
        
 \033[1;93m**************************************************
 \033[1;93m    \033[1;96m CREATED BY\33[0;m   :  \033[1;96mRUDRA_Z              \033[1;93m
 \033[1;93m     \033[1;32mFACEBOK      : \033[1;34m RAUDRA_Z     \033[1;93m
 \033[1;93m     \033[1;35mGITHUB       :  \033[1;35mfalto4437     \033[1;93m
 \033[1;93m     \033[1;36mTOOL STATUS  : \033[1;36m SMS-BOMBER       \033[1;93m
 \033[1;93m     \033[1;36mTOOL VIRSION :  \033[1;36m1.0.8                 \033[1;93m
 \033[1;93m**************************************************  """
linex=(' \033[1;93m**************************************************')  
...
def xak2(xak):
	for x in xak+"\n":
		...
		time.sleep(0.07)
os.system("clear")
os.system("espeak \"Welcome My Dear Hackers, BD SMS Bombing loading  PLEASE WAIT \"")
os.system("espeak \"DEVELOPER BY RUDRA Z YOUR NEXT CRASH \"")

print (logo)

os.system('clear')
print(logo)
print(w+"\033[1;36m[π] BD SMS BOMBING")
...
number=input(f"{c}\n\033[1;36m[Enter Your Target Number] :{w} +880 ")
amo=int(input(c+"\n\033[1;32m[SMS LIMITED] : "+w))
...
for i in range(amo):
	...
	os.system("espeak \" BD SMS BOMBING SUCCESSFUL\"")
